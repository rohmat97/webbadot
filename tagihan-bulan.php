...
<div class="container" style="text-align: center; font-size: 14pt; background-color: #00BFFF; margin-bottom: 20px;" >
  ...
  <br>
  <button name="tagihan" value="tagihan_hari" onclick="window.location='';">Januari</button>
  <button name="tagihan" value="tagihan_minggu" onclick="window.location='';">Februari</button>
  <button name="tagihan" value="tagihan_bulan" onclick="window.location='';">Maret</button>
  <button name="tagihan" value="tagihan_hari" onclick="window.location='';">April</button>
  <button name="tagihan" value="tagihan_minggu" onclick="window.location='';">Mei</button>
  <button name="tagihan" value="tagihan_bulan" onclick="window.location='';">Juni</button> 
  <button name="tagihan" value="tagihan_hari" onclick="window.location='';">Juli</button>
  <button name="tagihan" value="tagihan_minggu" onclick="window.location='';">Agustus</button>
  <button name="tagihan" value="tagihan_bulan" onclick="window.location='';">September</button>
  <button name="tagihan" value="tagihan_hari" onclick="window.location='';">Oktober</button>
  <button name="tagihan" value="tagihan_minggu" onclick="window.location='';">November</button>
